...
Ideas for the next releases:
	- Add a fonction in the chat that gives you an interesting info everyday.
	- Upgrade the animation of the banner() function.
	- Upgrade the visual side of the credits() function, make it more cute ;)
...
Je suspecte la fonction 'get_ftemp()' de ne pas donner un resultat correct,
l'éventuelle erreur se trouve au niveau de la formule mathématique, 
qui est sensé calculer la température ressentie en fonction de la vitesse du vent en km/h et de la température réele.
